...
const Detail = () => {
    ...
    return (
        <div className='p-4 w-full mt-4 flex flex-col md:flex-row items-center md:items-start justify-center'>
            {  loading? <div className='h-96 flex w-full justify-center items-center'><ThreeCircles  height={25} color='white'/> </div>:
                <>
            <img className='h-96 block  md:sticky top-24' src={data.image} alt='movie here' />
